...
public class ASCLayout extends LinearLayout {

   private static final String TAG = "ASCView:ViewGroup";

   public ASCLayout(Context context) {
      super(context);
   }

   public ASCLayout(Context context, @Nullable AttributeSet attrs) {
      super(context, attrs);
   }

   public ASCLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
