...
public class TextViewFragment extends BaseFragment {
   ...
   private String getTextInfo(TextView tv){
      ...
      sb.append("\ntextView行高（descent-ascent+leading）---->").append(tv.getLineHeight());
      sb.append("\ntextView descent---->").append(tv.getPaint().getFontMetrics().descent);
      sb.append("\ntextView ascent---->").append(tv.getPaint().getFontMetrics().ascent);
      sb.append("\ntextView leading---->").append(tv.getPaint().getFontMetrics().leading);
